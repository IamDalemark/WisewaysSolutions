...
const Testimonial = ({ testimonial, name, rating }: TestimonialProps) => {
  return (
    <div className="grid grid-rows-7 min-h-56 w-[60vw] md:w-[40vw] lg:w-[20vw] h-[60vh] border-[#FD8432] border p-4 rounded-2xl sm:m-2 justify-self-center mt-10  text-blue-green bg-white">
