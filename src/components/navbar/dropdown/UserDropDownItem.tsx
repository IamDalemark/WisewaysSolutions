...
import { LoggedInMenuItem } from "./UserLoggedInDropDown";
...
const UserDropDownItem = ({initialOpen}: Props) => {
    ...
    const LoggedItems: LoggedInMenuItem[] = [
        { label: "Log Out", context: "openLogInModal" },
        { label: "Forgot Password", context: "openSignUpModal" },
    ];
    ...
    return (
        ...
        {isOpen && (user ?
        <UserLoggedInDropDown menuItems={LoggedItems}/> :
