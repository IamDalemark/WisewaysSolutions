    ...
    const NavBar = () => {
        return (
        <nav className="w-[90%] sm:w-[86%] flex items-center bg-[#F3F3F3] fixed top-6 mx-[5%] sm:mx-[7%] rounded-3xl h-20 shadow-lg px-[2%] justify-between">
            ...
            <div className="flex w-[30%] md:w-[55%] lg:w-[30%] xl:w-[30%] mr-[2%] justify-end">
                <Link href="/booking" className="hidden md:flex h-5/8 w-[50%] lg:w-[60%] xl:[50%] py-1 mx-2 
                bg-blue-green text-[#F3F3F3] rounded-2xl leading-[1.25] items-center justify-center
