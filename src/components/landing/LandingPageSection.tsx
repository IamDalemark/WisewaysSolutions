...
const LandingPageSection = ({
  ...
  return (
   ...
   >
      ...
      {/* Image Section */}
      <div className="w-full md:w-[50%] justify-self-center self-center mt-10 lg:mt-0 relative">
         {!imageLoaded && (
            <div className="w-full aspect-[3/2] bg-[#a6a6a6] animate-pulse rounded-3xl max-w-[525px] mx-auto" />
         )}
         <Image
            src={imageSrc}
            alt={altText}
            height={350}
            width={525}
            className={`object-contain max-w-full h-auto justify-self-center transition-opacity duration-500 ${imageLoaded ? "opacity-100" : "opacity-0"}`}
