...
const NavBar = () => {
    return (
    <nav className="w-[90%] sm:w-[80%] flex items-center bg-[#F3F3F3] fixed top-6 mx-[5%] sm:mx-[10%] rounded-3xl h-20 shadow-lg/15 px-[2%] justify-between">
        
        <div className="flex w-[60%] md:w-[40%] lg:w-[65%] xl:w-[70%]">
            <Link href="/" className="w-[80%] lg:w-4/12 h-full ml-[4%] mr-[1%] xl:ml-[5%]"> 
        ...
        <div className="flex w-[30%] md:w-[55%] lg:w-[35%] xl:w-[30%] justify-end">
            <button className="hidden md:inline-block h-5/8 w-[50%] lg:w-[60%] xl:[50%] py-1 mx-2 bg-blue-green text-[#F3F3F3] rounded-2xl leading-[1.25] 
